...
@Component({
  selector: 'app-muscletech',
  templateUrl: './muscletech.component.html',
  styleUrls: ['./muscletech.component.css']
})
export class MuscletechComponent implements OnInit {
  ...
  constructor(private _rest: RestService, private _cart: CartService, private _activateroute: ActivatedRoute) { }
  ...
  muscletech() {
    ...
    this._rest.bybrandid(12).subscribe((data: any) => {
